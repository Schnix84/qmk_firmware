...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_iso_88(
        KC_ESC,   KC_BRID,  KC_BRIU,  KC_MCTRL, KC_LNPAD, RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_MUTE,   KC_SNAP,  KC_NO,    RGB_MOD,
        KC_NUBS,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,   KC_INS,   KC_LHOME,  KC_PGUP,
    ...
    [MAC_FN] = LAYOUT_iso_88(
        ...
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  KC_M_CL,  KC_M_CR,             _______,  _______,  _______,
        _______,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,  KC_M_SL,  KC_M_SR,  _______,
    ...
    [WIN_FN] = LAYOUT_iso_88(
        ...
        _______,  BT_HST1,  BT_HST2,  BT_HST3,  P2P4G,    _______,  _______,  _______,  _______,  _______,  _______,  KC_PAR_L, KC_PAR_R, _______,   _______,  _______, _______,
        RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  KC_W_CL,  KC_W_CR,             _______,  _______,  _______,
        _______,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,  KC_W_SL,  KC_W_SR,  _______,
    ...
    if (record->event.key.row == 0 && record->event.key.col == 14) {
        if (get_highest_layer(default_layer_state) == MAC_BASE) {
            if (record->event.pressed) {
                // Reliable external-keyboard path:
                // macOS can bind Dictation to a custom shortcut, and we send it
                // directly from the dedicated mic key in Mac mode.
        ...
        if (get_highest_layer(default_layer_state) == WIN_BASE) {
            if (record->event.pressed) {
                // Windows mic mute: emit Win+Alt+K
